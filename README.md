...
**TKTK: Describe election-2016 here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/election_2016/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|election-2016|tweet|`location`||
|election-2016|facebook|`location`||
|election-2016|email|`location`||
|election-2016|new-comment||
|election-2016|open-share-discuss||
|election-2016|close-share-discuss||
|election-2016|summary-copied||
|election-2016|featured-tweet-action|`action`|
|election-2016|featured-facebook-action|`action`|
